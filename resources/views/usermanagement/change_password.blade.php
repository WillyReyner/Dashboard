    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Formulario de Alteração de Senha</h3>
                <p class="text-subtitle text-muted">Alterar Senha</p>
            </div>
                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('change/password/db') }}" class="md-float-material">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            ...
                            name="current_password" value="{{ old('current_password') }}" placeholder="Coloque Senha Antiga">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-lg" name="new_confirm_password" placeholder="Confirme Nova Senha">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Alterar Senha</button>
                    </form>
                </div>
            </div>
